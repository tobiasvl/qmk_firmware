...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BL] = LAYOUT_iso(
    ...
    TT(_FL), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_NUHS, KC_ENT,  KC_PGUP, \
    KC_LSFT, KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_PGDN, \
    KC_LCTL, KC_LGUI, KC_LALT,                   SPACE_FN,                             KC_RALT, TT(_FL), KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_FL] = LAYOUT_iso(
    ...
    _______, KC_PGUP,   KC_UP, KC_PGDN, _______, _______, _______, _______, _______, _______, _______, _______, _______,          KC_INS,  \
